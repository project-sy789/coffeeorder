...
ScrollableDialogOverlay.displayName = "ScrollableDialogOverlay"
...
>(({ className, children, ...props }, ref) => (
  <ScrollableDialogPortal>
    ...
    >
      ...
      <ScrollableDialogClose className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
        <X className="h-4 w-4" />
...
const ScrollableDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left sticky top-0 bg-background z-10 pb-2",
      className
    )}
    {...props}
  />
...
ScrollableDialogTitle.displayName = "ScrollableDialogTitle"
...
ScrollableDialogDescription.displayName = "ScrollableDialogDescription"
