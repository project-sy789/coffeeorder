...
async function main() {
  ...
  if (success) {
    ...
    log('4. ตรวจสอบว่าทุกอย่างทำงานตามที่คาดหวังไว้', 'white');
    log('5. แบ่งปัน URL กับผู้ใช้ของคุณ', 'white');
    
    log('\nรายละเอียดการตั้งค่าผู้ดูแลระบบอยู่ในไฟล์ "คู่มือการตั้งค่าแอดมิน.md"', 'yellow');
  } else {
